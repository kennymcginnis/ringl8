...
class FoldingCellState extends State<FoldingCell> with SingleTickerProviderStateMixin {
        ...
        builder: (context, child) {
          ...
          return Padding(
            ...
            child: Container(
              ...
              height:
                  widget.cellSize.height + (widget.cellSize.height * _animationController.value),
                ...
                children: <Widget>[
                  ClipRRect(
                    borderRadius: BorderRadius.only(
                      ...
                      bottomLeft: _isExpanded ? Radius.zero : Radius.circular(widget.borderRadius),
                      bottomRight: _isExpanded ? Radius.zero : Radius.circular(widget.borderRadius),
                    ),
                    child: Container(
                  ...
                  Transform(
                    ...
                    child: Transform(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.only(
                          topLeft: _isExpanded ? Radius.zero : Radius.circular(widget.borderRadius),
                          topRight:
                              _isExpanded ? Radius.zero : Radius.circular(widget.borderRadius),
